...
Feature:
    ...
    Scenario: Send a request with query parameters: the current page is the last page
        ...
        And the node "totalOfPages" of the response should be 3
        And the node "elementsPerPage" of the response should be 5
        And the node "nextPage" of the response should be NULL
    ...
    Scenario: Send a request with query parameters: the current page is the first page
        ...
        And the node "totalOfPages" of the response should be 3
        And the node "elementsPerPage" of the response should be 5
        And the node "previousPage" of the response should be NULL
    ...
    Scenario: Send a request with query parameters: the current page is neither the first nor the last page
        ...
        And the node "totalOfPages" of the response should be 3
        And the node "elementsPerPage" of the response should be 5
        And the node "previousPage" of the response should be 1
        And the node "nextPage" of the response should be 3
    ...
    Scenario: Send a request with query parameters: the elements per page is too large
        ...
        Then I should receive a status code 200
        And the node "totalOfPages" of the response should be 2
        And the node "elementsPerPage" of the response should be 10
        And the node "previousPage" of the response should be NULL
